...
void MockEvents::mouseDown(Item* item, Point loc, MouseButton /*button*/, bool /*signalToItem*/)
{
...
void MockEvents::mouseUp(Item* item, Point loc, MouseButton /*button*/, bool /*signalToItem*/)
{
    if (onMouseClickEvent) {
